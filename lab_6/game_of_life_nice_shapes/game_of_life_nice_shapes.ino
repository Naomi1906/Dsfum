...
void loadPreset(int id){
  resetmatrix(a);
  switch(id){
case 0:a[2][1]=1;a[2][2]=1;a[3][0]=1;a[3][1]=1;a[4][1]=1;Serial.println("Preset: Glider");break;
case 1:a[2][2]=1;a[2][3]=1;a[3][1]=1;a[3][2]=1;a[4][2]=1;a[4][3]=1;Serial.println("Preset: Blinker");break;
case 2:a[2][3]=1;a[2][4]=1;a[3][2]=1;a[3][3]=1;a[3][4]=1;a[4][3]=1;Serial.println("Preset: Block");break;
case 3:a[1][3]=1;a[1][4]=1;a[2][2]=1;a[2][3]=1;a[3][3]=1;a[3][4]=1;a[4][4]=1;Serial.println("Preset: Toad");break;
case 4:a[2][2]=1;a[2][3]=1;a[3][3]=1;a[3][4]=1;a[4][3]=1;a[4][5]=1;a[5][4]=1;a[5][5]=1;Serial.println("Preset: R-pentomino");break;
case 5:a[1][2]=1;a[2][4]=1;a[3][1]=1;a[3][2]=1;a[3][5]=1;a[3][6]=1;a[4][3]=1;a[4][4]=1;Serial.println("Preset: Acorn");break;
case 6:a[2][3]=1;a[3][2]=1;a[3][3]=1;a[3][4]=1;a[4][3]=1;a[4][5]=1;a[5][4]=1;a[5][5]=1;Serial.println("Preset: Diehard mic");break;
case 7:a[1][2]=1;a[1][3]=1;a[2][2]=1;a[2][3]=1;a[2][5]=1;a[3][4]=1;a[3][5]=1;a[4][4]=1;Serial.println("Preset: Mini Glider Gun");break;
default:for(int i=0;i<12;i++)a[random(0,8)][random(0,8)]=1;Serial.println("Preset: Random");
}}

void generateRandomPopulation(){int preset=random(0,8);loadPreset(preset);}
